...
if (window.jsb) {
    ...
    (function () {
        ...
        var sysInfo, sysJson, currApkVersion = ''
        try {
            sysInfo = jsb.reflection.callStaticMethod('com.bw.game.bridge/JsbBridge', 'getSystemInfoSync', "()Ljava/lang/String;");
            sysJson = JSON.parse(sysInfo || '{}');
            currApkVersion = sysJson.data ? sysJson.data.apkVersion : '';
        } catch (e) { }
